...
// added ability to marshal unmarshal binaries
// carried over from the ability present in native golang crypto library
// at github.com/golang/go/blob/master/src/crypto/sha256/sha256.go
...
func (d *digest) UnmarshalBinary(b []byte) error {
	if string(b[:len(magic256)]) != magic256 {
